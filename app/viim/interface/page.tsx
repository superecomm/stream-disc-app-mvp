...
export default function AnimationTestPage() {
  const [state, setState] = useState<"idle" | "listening" | "speaking" | "recording" | "processing">("idle");
    ...
    if (autoToggle) {
      const interval = setInterval(() => {
        setState(prev => {
          ...
          if (prev === "speaking") return "recording";
  ...
  const changeState = (newState: "idle" | "listening" | "speaking" | "recording" | "processing", label: string) => {
    setState(newState);
    addLog(label);
  };
  ...
  const simulateConversation = async () => {
    ...
    await new Promise(r => setTimeout(r, 2000));
        ...
        changeState("speaking", "→ SPEAKING: 'Hello! How can I help you?'");
    await new Promise(r => setTimeout(r, 3000));
    
    changeState("listening", "→ LISTENING: Waiting for user response...");
    await new Promise(r => setTimeout(r, 2500));
    
        changeState("speaking", "→ SPEAKING: 'I can verify your voice identity.'");
    await new Promise(r => setTimeout(r, 3000));
  ...
  const simulateVerification = async () => {
    ...
    await new Promise(r => setTimeout(r, 2000));
        ...
        changeState("processing", "→ PROCESSING: Analyzing voice biometrics...");
    await new Promise(r => setTimeout(r, 4000));
    
        changeState("speaking", "→ SPEAKING: 'Voice verified. Welcome back!'");
    await new Promise(r => setTimeout(r, 2500));
  ...
  const simulateThinking = async () => {
    ...
    await new Promise(r => setTimeout(r, 3000));
        ...
        changeState("speaking", "→ SPEAKING: 'It's sunny with a high of 75°F'");
    await new Promise(r => setTimeout(r, 3000));
  ...
  const simulateIdeaDelivery = async () => {
    ...
    await new Promise(r => setTimeout(r, 2500));
        ...
        changeState("speaking", "→ SPEAKING: Delivering idea with neural stream");
    await new Promise(r => setTimeout(r, 4000));
  ...
  const simulateRecording = async () => {
    ...
    stopRecording();
    setRecordingCountdown(undefined);
        changeState("processing", "→ PROCESSING: Encoding voice data...");
    addLog("Recording stopped - processing audio");
    await new Promise(r => setTimeout(r, 2500));
    
        changeState("speaking", "→ SPEAKING: 'Recording saved successfully'");
    await new Promise(r => setTimeout(r, 2000));
  ...
  const simulateError = async () => {
    ...
    await new Promise(r => setTimeout(r, 2000));
        ...
        changeState("processing", "→ ERROR: Voice not recognized!");
    await new Promise(r => setTimeout(r, 2000));
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {(["idle", "listening", "speaking", "recording", "processing"] as const).map((s) => (
                  <button
                    key={s}
                    onClick={() => setState(s)}
                    className={`px-3 py-2 rounded-lg font-medium transition text-sm ${
                      state === s
                        ? s === "idle" ? "bg-gray-600 text-white" :
                          ...
                          s === "speaking" ? "bg-purple-600 text-white" :
                          s === "processing" ? "bg-yellow-600 text-white" :
        ...
        <div className="mb-8">
          ...
          <p className="text-center text-gray-500 text-sm mt-2">
            ...
            {state === "speaking" && "Neural waveform stream - magnetized horizontal flow"}
            {state === "processing" && "Swirling compact node - low-frequency pulse (thinking)"}
